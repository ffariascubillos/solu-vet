...
- Usa el MCP context7 para buscar documentación actualizada de un framework o librería (sintaxis de API, configuración, migración de versión) cuando la tarea lo requiera. Solo cuando sea necesario para resolver la tarea concreta, no lo consultes por costumbre en cada turno.
